...
const Home = () => {
    return (
        <main className="h-100 container">
            <div className=" h-100">
                <TextInput placeholder="Search ..." className="mb-20" />
                ...
                <div className="fw-400 text-gray description">
                    ...
                    Atoms can attach to one or more other atoms by chemical bonds to form chemical compounds such as molecules or crystals. The ability of atoms to attach and detach from each other is responsible for most of the physical changes observed in nature. Chemistry is the science that studies these changes.s
                </div>
            </div>
        </main>
    )
